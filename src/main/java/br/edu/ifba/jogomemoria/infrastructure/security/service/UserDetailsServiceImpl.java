package br.edu.ifba.jogomemoria.infrastructure.security.service;
...
public class UserDetailsServiceImpl implements UserDetailsService {
    ...
    public UserDetails loadUserByUsername(String username) {
        ...
        return new UserSecurity(user.getId(), user.getUsername(), user.getPassword(), user.getAuthorities());
    }
}